...
vuser_init()
{
	...
	send_data(fgw_host_id, null,2, "bgw_RelayRegiRequest"); 
	LrsSend("relay-bgw", "bgw_RelayRegiRequest" , "0");
    LrsReceive("relay-bgw", "buf1", "0");


	
	 
	send_data(bgw_host_id,fgw_host_id,0, "fgw_RelayQueryConnectionRe"); 
	LrsSend("relay-fgw", "fgw_RelayQueryConnectionRe" , "0");
    LrsReceive("relay-fgw", "buf2", "0");

	 
	send_data(bgw_host_id, null,2, "fgw_RelayRegiRequest"); 
	LrsSend("relay-fgw", "fgw_RelayRegiRequest" , "0");
    LrsReceive("relay-fgw", "buf1", "0");

	 
	 
	 
	send_data(fgw_host_id, bgw_host_id,4, "fgw_RelayMsgConnectionReq"); 
	LrsSend("relay-fgw", "fgw_RelayMsgConnectionReq" , "0");
    LrsReceive("relay-bgw", "buf_RelayMsgConnectionReq", "0");

	 
	 
	send_data(bgw_host_id,fgw_host_id,5, "bgw_RelayMsgConnectionRes"); 
	LrsSend("relay-bgw", "bgw_RelayMsgConnectionRes" , "0");
