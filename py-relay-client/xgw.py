...
def send_packet(host_id = 12, host_type = "device", app_server_list=[1201,1203]):
    p_version = 0
    p_msg_type = 8
    i_host_id = host_id
    ...
    s_packet_body = struct.pack(_body_Format, i_host_id, p_host_type, p_data_type, p_host_key_length, host_key) + s_app_server
